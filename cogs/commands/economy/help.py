...
class HelpCog(Cog):
    ...
    async def help(self, ctx: SlashContext):
        ...
        embed.add_field(
            name="​", value=f"✨ **The store system:** {store}", inline=False
        )
        ...
        embed.add_field(
            name="​", value=f"✨ **Color packs:** {color_packs}", inline=False
        )
        ...
        embed.add_field(
            name="​", value=f"✨ **Freeleech token:** {freeleech_token}", inline=False
        )
        ...
        embed.add_field(
            name="​", value=f"✨ **Custom role:** {custom_role}", inline=False
        )
        ...
        embed.add_field(
            name="​", value=f"✨ **Achievement:** {achievement}", inline=False
        )
    ...
    async def commands(self, ctx: SlashContext):
        ...
        embed.add_field(
            name="​", value=f"✨ **/buy nickname:** {buy_nickname}", inline=False
        )
        ...
        embed.add_field(
            name="​", value=f"✨ **/upgrade daily:** {upgrade_daily}", inline=False
        )
        ...
        embed.add_field(
            name="​", value=f"✨ **/upgrade hue:** {upgrade_hue}", inline=False
        )
        ...
        embed.add_field(
            name="​", value=f"✨ **/upgrade value:** {upgrade_value}", inline=False
        )
