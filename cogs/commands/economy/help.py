...
class HelpCog(Cog):
    ...
    async def help(self, ctx: SlashContext):
        ...
        buffer = "Your experience point, gained mainly by participating in conversations. Short messages will give less buffer, " \
        ...
        uploads = "Your message count in this server. Does not count your messages retroactively before the system exists."
        embed.add_field(name="​", value=f"✨ **Upload:** {uploads}", inline=False)

        user_class = "Your rank on the server. There are 8 ranks in total, where:\n\n" \
                     "__Member__: The lowest rank, with basic permissions.\n\n" \
                     "__User__: /buy nickname command is unlocked. Requires 10240 MB (10 GB) buffer and 1000 uploads.\n\n" \
        ...
        color_packs = "Based on the HSV color system with 3 primary (red, green, blue) hues and 3 secondary (yellow, cyan, magenta) hues. " \
        ...
        saturation = "Based on the HSV color system. The higher the saturation level, the better the chance you can roll colors with " \
                     "a higher intensity"
        ...
        vouch = "Earned by having other members using /vouch on you for helping them out, typically by answering questions. The vouched " \
        ...
        achievement = "Your achievements in this server by meeting specific criteria. It could be something simple, but could also be " \
