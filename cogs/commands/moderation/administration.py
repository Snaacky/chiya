...
class AdministrationCog(Cog):
    ...
    async def create_color_roles_embed(self, ctx: Context):
        embed = discord.Embed(
            description=f"You can react to one of the squares below to be assigned a colored user role. If you are interested in a different color, you can become a <@&{config.role_server_booster}> to receive a custom colored role.")
