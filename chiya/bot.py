...
async def setup_logger():
    ...
    log.add(sys.stdout, format=fmt, level=log_level, backtrace=False, diagnose=False)
    log.add(os.path.join("logs", "bot.log"), format=fmt, rotation="1 day", backtrace=False, diagnose=False)
