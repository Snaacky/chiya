        ...
        if datetime.now(timezone.utc) - member.created_at < timedelta(days=183):
            user_embed = embeds.make_embed(
                ...
                fields=[
                    ...
                    {
                        "name": "Reason:",
                        "value": "We do not allow new Discord accounts to participate in our community to avoid bots and alt accounts. Please switch to your main account or try again at a later date.",
                        "inline": False,
                    },
                ],
            )
